...
interface NewTravelDestinationDialogMapper : Mapper<NewTravelDestinationDialogMapper.Params, DialogData> {
  data class Params(
    val type: DialogType,
...
class NewTravelDestinationDialogMapperImpl : NewTravelDestinationDialogMapper {
  override fun invoke(params: NewTravelDestinationDialogMapper.Params): DialogData =
    when (params.type) {
      NewTravelDestinationDialogMapper.DialogType.Close -> DialogData(
