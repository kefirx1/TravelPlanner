...
interface NewTravelOriginDialogMapper : Mapper<NewTravelOriginDialogMapper.Params, DialogData> {
  data class Params(
    val type: DialogType,
...
class NewTravelOriginDialogMapperImpl : NewTravelOriginDialogMapper {
  override fun invoke(params: NewTravelOriginDialogMapper.Params): DialogData =
    when (params.type) {
      NewTravelOriginDialogMapper.DialogType.Close -> DialogData(
